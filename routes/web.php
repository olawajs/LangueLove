...
Route::GET('testSes', [App\Http\Controllers\Admin\AdministratorController::class, 'testSes'])->name('testSes');
Route::GET('testSes2', [App\Http\Controllers\Admin\AdministratorController::class, 'testSes2'])->name('testSes2');
