...
<!-- Language modal -->
  ...
  <!-- end LM -->
  <!-- kilka pakietow modal -->
<div class="StickDiv" id="MFewPackets" style="display:none; top: 50%; padding: 20px">
    <div class='desktop'>
        <div class='d-flex' style="flex-flow: column;">
            <div class="DivHead" style="justify-content: end;">
                <button class="btn XButton" onClick="closeModal('MFewPackets')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M0.362686 11.4335L4.68772 7L0.362686 2.56647C0.108271 2.30567 0.108271 1.87892 0.362686 1.61812L1.7504 0.195597C2.00481 -0.065199 2.42113 -0.065199 2.67554 0.195597L7.00058 4.62913L11.3256 0.195597C11.58 -0.065199 12.0195 -0.065199 12.2739 0.195597L13.6385 1.61812C13.8929 1.87892 13.8929 2.30567 13.6385 2.56647L9.31343 7L13.6385 11.4335C13.8929 11.6943 13.8929 12.1448 13.6385 12.4056L12.2739 13.8044C12.0195 14.0652 11.58 14.0652 11.3256 13.8044L7.00058 9.37087L2.67554 13.8044C2.42113 14.0652 2.00481 14.0652 1.7504 13.8044L0.362686 12.4056C0.108271 12.1448 0.108271 11.6943 0.362686 11.4335Z" fill="#2B2B33"/>
                    </svg>
                </button>
            ...
            <div style="padding: 80px;
                    ...
                    gap:24px;
                    padding-top: 20px;">
                <span class="HeadText" style="margin-bottom:16px; font-size: 20px">Wybierz pakiet, który chcesz wykorzystać:</span>
                @foreach($lessonAmount as $k => $LA)
                    @foreach($LA as $k2 => $LA2)
                        @foreach($LA2 as $k3 => $LA3)
                            <button class="btn LL-button LL-button-primary" style="width: 500px" onclick="SetPacket('{{$k}}','{{$k2}}','{{$k3}}',{{$LA3['ile']}},{{$LA3['jezyk']}},{{$LA3['dlugosc']}},{{$LA3['typ']}},{{$LA3['cert']}})">{{$k}} {{$k2}} {{$k3}} (zostało: {{$LA3['ile']}})</button>
                        @endforeach
                    @endforeach
                @endforeach
            </div>
    ...
    <div class='mobile mobileFlex' style="width: 100%;">
        ...
        <div class="d-flex" style="flex-flow: column; gap:12px">
            <span class="HeadText" style="margin-bottom:16px; font-size: 20px">Wybierz pakiet, który chcesz wykorzystać:</span>
                @foreach($lessonAmount as $k => $LA)
                    @foreach($LA as $k2 => $LA2)
                        @foreach($LA2 as $k3 => $LA3)
                            <button class="btn LL-button LL-button-primary" style="width: 100%; font-size:12px" onclick="SetPacket('{{$k}}','{{$k2}}','{{$k3}}',{{$LA3['ile']}},{{$LA3['jezyk']}},{{$LA3['dlugosc']}},{{$LA3['typ']}},{{$LA3['cert']}})">{{$k}} {{$k2}} {{$k3}} (zostało: {{$LA3['ile']}})</button>
                        @endforeach
                    @endforeach
                @endforeach
        </div>
...
<!-- wybór wersji -->
<div class="PacketDiv" id="PacketDiv" style="display:none;">
    <div class='desktop'>
        <div class='d-flex' style="flex-flow: column; gap:60px;">
            <div class="DivHead">
                <span class="HeadText">Szczegóły rezerwacji</span>
                <button class="btn XButton" onClick="closePacketDiv()">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M0.362686 11.4335L4.68772 7L0.362686 2.56647C0.108271 2.30567 0.108271 1.87892 0.362686 1.61812L1.7504 0.195597C2.00481 -0.065199 2.42113 -0.065199 2.67554 0.195597L7.00058 4.62913L11.3256 0.195597C11.58 -0.065199 12.0195 -0.065199 12.2739 0.195597L13.6385 1.61812C13.8929 1.87892 13.8929 2.30567 13.6385 2.56647L9.31343 7L13.6385 11.4335C13.8929 11.6943 13.8929 12.1448 13.6385 12.4056L12.2739 13.8044C12.0195 14.0652 11.58 14.0652 11.3256 13.8044L7.00058 9.37087L2.67554 13.8044C2.42113 14.0652 2.00481 14.0652 1.7504 13.8044L0.362686 12.4056C0.108271 12.1448 0.108271 11.6943 0.362686 11.4335Z" fill="#2B2B33"/>
                    </svg>
                </button>
            ...
            <div>
                <span class="HeadText2">Wybierz odpowiednią dla Ciebie opcję:</span>
            </div>
            <div class="d-flex">
                <div class="" style="padding-right: 32px;  border-right: 1px solid var(--langue-love-light-grey);">
                    <div class="PayHead">
                        <div style="min-height: 40px;line-height: 130%">
                            <span class="UnderText" style="color: #2B2B33;font-size: 20px;">Chcę wykorzystać zajęcia z mojego pakietu</span> 
                        </div>
                    </div>
                    <div>
                        <buton class="LL-button LL-button-primary w-100" onclick="OpenChooseTable()">Wybieram</buton>
                    </div>
                </div>
                <div class="" style="padding-left: 32px;">
                    <div class="PayHead">
                        <div style="min-height: 40px;line-height: 130%">
                            <span class="UnderText" style="color: #2B2B33;font-size: 20px;">Chcę wykupić inny typ zajęć u tego lektora </span>
                        </div>   
                    </div>
                    <div>
                        <buton class="LL-button LL-button-primary w-100"  onclick="OpenPaymentTable()">Wybieram</buton>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class='mobile mobileFlex' style="width: 100%;">
        ...
        <div>
            <!-- test -->
            <div class="container">
                <div id="S1" class="Paymentcard2">
                    <div class="PaymentColumn" style="padding-right: 32px;">
                        <div class="">
                            <div style="min-height: 40px;line-height: 130%">
                                <span class="UnderText" style="color: #2B2B33;font-size: 16px;">Chcę wykorzystać zajecia z mojego pakietu</span> 
                            </div>
                        </div>
                        <div>
                            <buton class="LL-button LL-button-primary w-100" onclick="OpenChooseTable()">Wybieram</buton>
                ...
                <div id="S2" class="Paymentcard2">
                    <div class="PaymentColumn">
                        <div class="">
                            <div style="min-height: 40px;line-height: 130%">
                                <span class="UnderText" style="color: #2B2B33;font-size: 16px;">Chcę wykupić inny typ zajęć u tego lektora </span>
                            </div>   
                        </div>
                        <div>
                            <buton class="LL-button LL-button-primary w-100"  onclick="OpenPaymentTable()">Wybieram</buton>
            ...
            <div class="ButtonsDiv">
                <div class="page-item2 active2"><a class="page-link2" data="1" id="1C"></a></div>
                <div class="page-item2"><a class="page-link2" data="2" id="2C"></a></div>
            </div>
        </div>
    </div>
</div>
<!-- Podsumowanie pakietu -->
<div class="StickDiv" id="PLesson" style="display: none;">
    <div class='desktop'>
        <div class='d-flex' style="flex-flow: column; gap:60px;">
            <div class="DivHead">
                <span class="HeadText">Szczegóły rezerwacji</span>
                <button class="btn XButton" onClick="closeModal('PLesson')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M0.362686 11.4335L4.68772 7L0.362686 2.56647C0.108271 2.30567 0.108271 1.87892 0.362686 1.61812L1.7504 0.195597C2.00481 -0.065199 2.42113 -0.065199 2.67554 0.195597L7.00058 4.62913L11.3256 0.195597C11.58 -0.065199 12.0195 -0.065199 12.2739 0.195597L13.6385 1.61812C13.8929 1.87892 13.8929 2.30567 13.6385 2.56647L9.31343 7L13.6385 11.4335C13.8929 11.6943 13.8929 12.1448 13.6385 12.4056L12.2739 13.8044C12.0195 14.0652 11.58 14.0652 11.3256 13.8044L7.00058 9.37087L2.67554 13.8044C2.42113 14.0652 2.00481 14.0652 1.7504 13.8044L0.362686 12.4056C0.108271 12.1448 0.108271 11.6943 0.362686 11.4335Z" fill="#2B2B33"/>
                    </svg>
                </button>
            ...
            <div class="d-flex" style="flex-flow: column">
                <div class="container">
                    <div class="">
                        <div class="PayInfo" style="gap: 24px;">
                            <div class="PayLabel">
                                <div class="PayIcon"><img src="{{asset('images/svg/cap.svg')}}"></div>
                                <div id="IndNazwa3">Pojedyncze zajęcia</div>
                            </div>    
                            <div class="PayLabel">
                                <div class="PayIcon"><img src="{{asset('images/svg/calendar.svg')}}"></div>
                                <div><span id="IndData3">01.09.2023</span> (<span id="IndDzien3">piątek</span>), <span id="IndGodz3">09:00 - 9:55</span></div>
                            </div>    
                            <div class="PayLabel">
                                <div class="PayIcon"><img src="/images/lectors/{{$lector->photo}}" style='width:48px; height: 48px; object-fit: cover;'></div>
                                <div>{{$lector->name}}</div>
            ...
            <div class="PaymentButtons">
                <button class="btn LL-button LL-button-primary" onClick="UseLesson()">Rezerwuj</button>
                <button class="btn LL-button LL-button-secondary" onClick="przejdzDo()">Zmień termin</button>
            </div>
        </div>
    </div>
    <div class='mobile mobileFlex' style="width: 100%;">
        ...
        <div class="d-flex" style="flex-flow: column">
                <div class="container">
                    <div class="">
                        <div class="PayInfo" style="gap: 34px;">
                            <div class="PayLabel">
                                <div class="PayIcon"><img src="{{asset('images/svg/cap.svg')}}"></div>
                                <div id="IndNazwaM3">Pojedyncze zajęcia</div>
                            </div>    
                            <div class="PayLabel">
                                <div class="PayIcon"><img src="{{asset('images/svg/calendar.svg')}}"></div>
                                <div><span id="IndData3M">01.09.2023</span> (<span id="IndDzien3M">piątek</span>), <span id="IndGodz3M">09:00 - 9:55</span></div>
                            </div>    
                            <div class="PayLabel">
                                <div class="PayIcon"><img src="/images/lectors/{{$lector->photo}}" style='width:48px; height: 48px; object-fit: cover;'></div>
                                <div>{{$lector->name}}</div>
...
<!-- Podziękowanie -->
<div class="StickDiv" id="ThankYou" style="display: none">
    <div class='desktop'>
        <div class='d-flex' style="flex-flow: column; gap:32px;">
            <div class="DivHead" style="justify-content: end;">
                <button class="btn XButton" onClick="closeModal('ThankYou')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M0.362686 11.4335L4.68772 7L0.362686 2.56647C0.108271 2.30567 0.108271 1.87892 0.362686 1.61812L1.7504 0.195597C2.00481 -0.065199 2.42113 -0.065199 2.67554 0.195597L7.00058 4.62913L11.3256 0.195597C11.58 -0.065199 12.0195 -0.065199 12.2739 0.195597L13.6385 1.61812C13.8929 1.87892 13.8929 2.30567 13.6385 2.56647L9.31343 7L13.6385 11.4335C13.8929 11.6943 13.8929 12.1448 13.6385 12.4056L12.2739 13.8044C12.0195 14.0652 11.58 14.0652 11.3256 13.8044L7.00058 9.37087L2.67554 13.8044C2.42113 14.0652 2.00481 14.0652 1.7504 13.8044L0.362686 12.4056C0.108271 12.1448 0.108271 11.6943 0.362686 11.4335Z" fill="#2B2B33"/>
                    </svg>
                </button>
            </div>
            <div class="d-flex" style="gap: 32px; flex-flow: column;align-items: center;">
                <div><img src="{{asset('images/svg/pinkCheck.svg')}}"></div>
                <span class="HeadText" style="font-size: 20px;    text-align: center;">Twoje zajęcia zostały zarezerwowane</span>
                <button class="btn LL-button LL-button-primary" onClick="przejdzDo()">Zarezerwuj kolejne</button>
            </div>
        </div>
    </div>
    <div class='mobile mobileFlex' style="width: 100%;">
...
<script  id="1">
    ...
    let LBjezyk,LBdlugosc,LBtyp,LBcert; //zmienne do pakietów
    let PaymentType = '';
    let packetAmount = 0;
    let nameType = '';
    let kwota = 0;
    ...
    $(document).ready(function () {
        ...
        $(".Paymentcard2").each(function(index, value){
            $('.Paymentcard2').hide();
        });         
        ...
        $(".page-link2").on('click', function(){
            ...
            $(".page-link2").each(function(index, value){
                $(value).parent().removeClass("active2");
            });
            ...
            var cardId = "#S" + $(this)[0].attributes.data.value;
        ...
        function checkDirection2() {
            ...
            let now2 = active[0].childNodes[0].attributes.data.value;
            let cardId;
            let id2;
            if (touchendX < touchstartX && Math.abs(roznica)>20){
                if(now2 == 1){
    ...
    function SetPacket(typ,czas,egzamin,zostalo,jezyk,dlugosc,typZ,cert){
        LBjezyk =jezyk;
        LBdlugosc =dlugosc;
        LBtyp =typZ;
        LBcert = cert;
        document.getElementById('IndNazwaM3').innerText ='Pakiet: '+typ+ ' '+czas+' '+egzamin;
        document.getElementById('IndNazwa3').innerText ='Pakiet: '+typ+ ' '+czas+' '+egzamin;
        document.getElementById('IndData3').innerText = ZajeciaData;
        document.getElementById('IndDzien3').innerText = dzienNazwa;
        document.getElementById('IndGodz3').innerText = Savedhour+'\n +'+(zostalo-1)+' do wykorzystania';
        document.getElementById('IndData3M').innerText = ZajeciaData;
        document.getElementById('IndDzien3M').innerText = dzienNazwa;
        document.getElementById('IndGodz3M').innerText = Savedhour+'\n +'+(zostalo-1)+' do wykorzystania';
        closeModal('MFewPackets');
        document.getElementById('PLesson').style.display = 'block';
        document.getElementById('container').style.filter = 'blur(15px)';
        window.scrollTo(0, 0);
    }
    function OpenHour(hour,dataZ,dzien,l60,l90){
        ...
        Object.entries(LessonAmount).forEach(([key, value]) => {
    ...
    function UseLesson(){
        $.ajax({
        type: "POST",
        url: '../payment/useLessons',
        data: {
            data: ZajeciaData, 
            godzina: Savedhour, 
            duration_id: LBdlugosc,
            jezyk: LBjezyk,
            rodzaj: LBtyp,
            lectorId: '{{$lector->id}}',
            cert: LBcert,
            LectorType: '{{$lector->lector_type_id}}',
            _token: "{{ csrf_token() }}",
            },
        })
        .done(function(data) {
           ...
           document.getElementById('PLesson').style.display = 'none';
        })
        .fail(function() {
